...
<head>
	...
	<title>NAGFX Products & Services</title>
...
<!--- using include command to include the shopping cart website -->
<div class ="container-fluid padding">
	<div class="row about text-center">
		<div class="col-12">
			<h1 class="display-2">Products Page!</h1>
		</div>
		<hr>
		<div class="col-12">
		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-2">
			<a href="success.php" ><button type="button" class="btn btn-outline-secondary btn-lg" onclick=" window.open('success.php','_blank')">
				Pay/Checkout
			</button></a>
		</div>
</div>
