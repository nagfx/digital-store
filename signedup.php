...
<head>
	...
	<title>NAGFX Successfully signed up</title>
...
<div class ="container-fluid padding">
	<div class="row about text-center">
		<div class="col-12">
			<h1 class="display-2">Successfully registered!</h1>
		</div>
		<hr>
		<div class="col-12">
			<p>You are registered now! <a href='login.php'>Click here to login</a></p>
